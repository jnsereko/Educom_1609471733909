...
class ClassList extends Component {
  ...
  componentWillMount() {
    this.props.navigation.addListener("willFocus", async () => { 
      ...
      // Load list
      this.props.actionsClass.loadClassList();
    });
  }
  ...
  deleteRow(secId, rowId, rowMap, data) {
    let that = this;
    this.props.actionsClass.deleteClass(data._id).then(() => {
        ...
        <Header>
          ...
          <Right>
            <Button
              transparent
              name="menu"
              onPress={() => this.props.navigation.navigate("ClassEdit")}
            >
              <Text>Add</Text>
            </Button>
          </Right>
...
function mapStateToProps(state, ownProps) {
  return {
    list: state.ClassListReducer.listClass
  };
}
